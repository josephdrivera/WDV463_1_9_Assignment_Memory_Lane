        ...
        <div className="grid md:grid-cols-2 py-3">
            ...
            <div className="info flex justify-center flex-col">
                <div className="category">
                    <Link href={"/"}></Link>
                    <Link href={"/"}>APRIL 30, 2023</Link>
                </div>
                <div className="title">
                    <Link href={"/posts/entry5"}>Unlocking the Power of JSON Web Tokens: A Comprehensive Guide</Link>
                </div>
                <p className="text-gray-500 py-3">SON Web Tokens (JWTs) have emerged as a prominent solution for authentication and authorization in modern web applications. JWTs offer a compact and secure way to transmit data between two parties, providing a stateless and scalable mechanism to ensure the integrity and authenticity of information. This article will discuss the core components and benefits of JWTs, as well as their practical implementation.
                    ...
                    JSON Web Tokens offer a powerful and flexible solution for authentication and authorization in web applications. By understanding the core components, benefits, and implementation process, developers can harness the power of JWTs to create secure and scalable applications.</p>
            </div>
        </div>
    )
}